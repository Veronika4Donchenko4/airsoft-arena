...
import 'order_game_page_model.dart';
export 'order_game_page_model.dart';

class OrderGamePageWidget extends StatefulWidget {
  const OrderGamePageWidget({
    super.key,
  ...
  static String routeName = 'OrderGamePage';
  static String routePath = '/orderGamePage';

  @override
  State<OrderGamePageWidget> createState() => _OrderGamePageWidgetState();
}

class _OrderGamePageWidgetState extends State<OrderGamePageWidget> {
  late OrderGamePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrderGamePageModel());
    ...
    _model.textFieldCityTextController ??= TextEditingController(
        text: widget.clubDoc.city.description);
    ...
    _model.allowFreeJoin = false;
    _model.citySselect = widget.clubDoc.city;
                                            ...
                                            child: Container(
                                              ...
                                              child: Stack(
                                                children: [
                                                  ...
                                                  // City field is read-only for order page
                                                  Container(
                                                    width: double.infinity,
                                  ...
                                  child: wrapWithModel(
                                    ...
                                    child: GeneralButtomWidget(
                                      ...
                                      isActive: (_model
                                          ...
                                          (_model.textFieldPasswordController!.text.isNotEmpty),
