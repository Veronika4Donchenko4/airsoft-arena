                  ...
                  children: [
                                        ...
                                        return Dialog(
                                          ...
                                          child: WebViewAware(
                                            child: GestureDetector(
                                              ...
                                              child: ActionTeamDialogWidget(
                                                teamDoc: containerTeamRecord,
                                                gameRef:
                                                    widget!.gameDoc!.reference,
                                                usedColor: widget!.usedColor,
                                              ),
                                            ),
                                          ),
                                        );
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 8.0, 16.0, 0.0),
                                      child: Text(
                                        containerTeamRecord.description,
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.inter(
                                    ...
                                    if ((containerTeamRecord.userCaptain ==
                                      ...
                                      Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            context.pushNamed(
                                              AppliListTeamPageWidget.routeName,
                                              queryParameters: {
                                                ...
                                                children: [
                                                  Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        'Заявки: ${containerTeamRecord.applicationList.length.toString()}',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .bodyMedium
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text(
                                            'Участники команды: ${containerTeamRecord.usersJob.length.toString()}/${widget!.gameDoc?.playersLimit?.toString()}',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  font: GoogleFonts.inter(
                                                          ...
                                                          child: Padding(
                                                            ...
                                                            child:
                                                              ...
                                                              child:
                                                                  TeamUserItemWidget(
                                                                key: Key(
                                                                  'Keyy03_${teamUsersListIndex.toString()}',
                                                                ),
                                                                captain:
                                                                    containerTeamRecord
                                                                        .userCaptain!,
                    ...
                    Padding(
                      ...
                      child: Column(
                        mainAxisSize: MainAxisSize.max,
                        children: [
                          if ((containerTeamRecord.recruitmentOpen == true) &&
                              (containerTeamRecord.usersJob.length <
                                  widget!.gameDoc!.playersLimit))
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 0.0, 1.0, 0.0),
                              child: wrapWithModel(
