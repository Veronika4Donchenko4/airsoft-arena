...
import 'edit_kills_model.dart';
export 'edit_kills_model.dart';

class EditKillsWidget extends StatefulWidget {
  const EditKillsWidget({
    super.key,
  ...
  @override
  State<EditKillsWidget> createState() => _EditKillsWidgetState();
}

class _EditKillsWidgetState extends State<EditKillsWidget> {
  late EditKillsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditKillsModel());

    // On component load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.killsCounter = widget!.gameUserDoc!.kills;
      safeSetState(() {});
    });
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: wrapWithModel(
                                  ...
                                  child: PlusMinysBottomWidget(
                                    withPlus: true,
                                    isActiv: _model.killsCounter < widget.maxKills,
                                    action: () async {
                                      _model.killsCounter =
                                          _model.killsCounter + 1;
                                      safeSetState(() {});
