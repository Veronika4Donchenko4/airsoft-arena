...
import 'action_with_player_model.dart';
export 'action_with_player_model.dart';

class ActionWithPlayerWidget extends StatefulWidget {
  const ActionWithPlayerWidget({
    super.key,
  ...
  @override
  State<ActionWithPlayerWidget> createState() => _ActionWithPlayerWidgetState();
}

class _ActionWithPlayerWidgetState extends State<ActionWithPlayerWidget> {
  late ActionWithPlayerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ActionWithPlayerModel());
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Icon(
                                            FFIcons.kreferArrowIcon,
                                            color: FlutterFlowTheme.of(context)
                                                .primaryText,
                                            size: 20.0,
                                          ),
                                          Text(
                                            'Передать свою должность',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  font: GoogleFonts.inter(
                            ...
                            builder: (dialogContext) {
                              return Dialog(
                                ...
                                alignment: AlignmentDirectional(0.0, 0.0)
                                    .resolve(Directionality.of(context)),
                                child: WebViewAware(
                                  child: DeleteUserFromTeamWidget(
                                    userJob: widget!.userJob!,
                                    teamDoc: widget!.teamDoc!,
                                  ),
                                ),
