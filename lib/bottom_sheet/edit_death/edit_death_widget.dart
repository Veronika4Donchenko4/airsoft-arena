...
import 'edit_death_model.dart';
export 'edit_death_model.dart';

class EditDeathWidget extends StatefulWidget {
...
class _EditDeathWidgetState extends State<EditDeathWidget> {
  late EditDeathModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditDeathModel());

    // On component load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.deathCounter = widget!.gameUserDoc!.deth;
      safeSetState(() {});
    });
