...
import 'invitation_to_team_model.dart';
export 'invitation_to_team_model.dart';

class InvitationToTeamWidget extends StatefulWidget {
  const InvitationToTeamWidget({
    super.key,
  ...
  @override
  State<InvitationToTeamWidget> createState() => _InvitationToTeamWidgetState();
}

class _InvitationToTeamWidgetState extends State<InvitationToTeamWidget> {
  late InvitationToTeamModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InvitationToTeamModel());
                                  ...
                                  child: StreamBuilder<List<JobRecord>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      final containerJobRecord =
                                          containerJobRecordList.isNotEmpty
                                            ...
                                            child: GeneralButtomWidget(
                                              ...
                                              onTap: () async {
                                                ...
                                                ScaffoldMessenger.of(context)
                                                  ...
                                                  SnackBar(
                                                    content: Text(
                                                      'Вы присоеденились к команде «${containerTeamRecord.name}»',
                                                      style: TextStyle(
                                                        color:
                                                            FlutterFlowTheme.of(
                                                                    context)
