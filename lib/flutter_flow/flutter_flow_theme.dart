...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFADE962);
  late Color secondary = const Color(0xFF39D2C0);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF61636B);
  late Color primaryBackground = const Color(0xFF18181A);
  late Color secondaryBackground = const Color(0xFF1B1B1D);
  late Color accent1 = const Color(0xFF303136);
  late Color accent2 = const Color(0xFF242528);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xFF31C455);
  late Color warning = const Color(0xFFFEDC34);
  late Color error = const Color(0xFFFF453A);
  late Color info = const Color(0xFFFFFFFF);

  late Color thirdText = const Color(0xFF96979C);
  late Color forTeam1 = const Color(0xFF9E62E9);
  late Color forTeam2 = const Color(0xFF62E9E1);
  late Color overlay = const Color(0xCB0A0B0F);
}
