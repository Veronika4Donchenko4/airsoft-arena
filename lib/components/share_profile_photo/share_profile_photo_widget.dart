...
import 'share_profile_photo_model.dart';
export 'share_profile_photo_model.dart';

class ShareProfilePhotoWidget extends StatefulWidget {
  const ShareProfilePhotoWidget({
    super.key,
    required this.user,
  });
  ...
  @override
  State<ShareProfilePhotoWidget> createState() =>
      _ShareProfilePhotoWidgetState();
}

class _ShareProfilePhotoWidgetState extends State<ShareProfilePhotoWidget> {
  late ShareProfilePhotoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShareProfilePhotoModel());
                                                      ...
                                                      padding:
                                                          EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  0.0),
                                                      child: Text(
                                                        '${functions.getCurrentUserRatePlace(containerUserRecordList.toList(), containerUserRecord.reference).toString()} место',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .bodyMedium
                          ...
                          child: StreamBuilder<List<UserAchievementsRecord>>(
                            stream: queryUserAchievementsRecord(
                              queryBuilder: (userAchievementsRecord) =>
                                ...
                                'user',
                                isEqualTo: containerUserRecord.reference,
                              ),
                            ),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
                                      ...
                                      return MasonryGridView.builder(
                                        ...
                                        itemBuilder:
                                          ...
                                          return wrapWithModel(
                                            ...
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: AchievementItemSmollWidget(
                                              key: Key(
                                                'Key2zg_${staggeredViewAchievementRecord.reference.id}',
                                              ),
                                              achivDoc:
                                                  staggeredViewAchievementRecord,
                                              userAchievments:
                      ...
                      Expanded(
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              8.0, 0.0, 0.0, 0.0),
                          child: Text(
                            'Рейтинг игрока, предоставленный \nAirsoft Arena',
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  font: GoogleFonts.inter(
