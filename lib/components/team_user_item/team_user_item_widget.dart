...
import 'team_user_item_model.dart';
export 'team_user_item_model.dart';

class TeamUserItemWidget extends StatefulWidget {
  const TeamUserItemWidget({
    super.key,
  ...
  final DocumentReference? captain;

  @override
  State<TeamUserItemWidget> createState() => _TeamUserItemWidgetState();
}

class _TeamUserItemWidgetState extends State<TeamUserItemWidget> {
  late TeamUserItemModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TeamUserItemModel());
      ...
      builder: (context, snapshot) {
        ...
        return Container(
          ...
          child: StreamBuilder<JobRecord>(
            stream: JobRecord.getDocument(widget!.userJob!.job!),
            builder: (context, snapshot) {
              // Customize what your widget looks like when it's loading.
              if (!snapshot.hasData) {
                return Center(
                ...
                child: Row(
                  ...
                  children: [
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            if ((containerUserRecord.reference ==
                                    widget!.captain) &&
                                (currentUserReference != widget!.captain))
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    4.0, 0.0, 0.0, 0.0),
                                child: Text(
                    ...
                    Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        if (currentUserReference == widget!.captain
                            ? true
                            : (containerUserRecord.reference != widget!.captain
                                ? true
                                : false))
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
