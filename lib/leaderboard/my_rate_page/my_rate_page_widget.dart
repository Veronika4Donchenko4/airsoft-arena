...
import 'my_rate_page_model.dart';
export 'my_rate_page_model.dart';

class MyRatePageWidget extends StatefulWidget {
  const MyRatePageWidget({super.key});

  static String routeName = 'MyRatePage';
  static String routePath = '/myRatePage';

  @override
  State<MyRatePageWidget> createState() => _MyRatePageWidgetState();
}

class _MyRatePageWidgetState extends State<MyRatePageWidget> {
  late MyRatePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyRatePageModel());
                                                      ...
                                                      padding:
                                                          EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  0.0),
                                                      child: Text(
                                                        '${functions.getCurrentUserRatePlace(containerUserRecordList.toList(), currentUserReference!).toString()} место',
                                        ...
                                        itemBuilder:
                                          ...
                                          return wrapWithModel(
                                            ...
                                            child: AchievementItemWidget(
                                              key: Key(
                                                'Keywy2_${staggeredViewAchievementRecord.reference.id}',
                                              ),
                                              achivDoc:
                                                  staggeredViewAchievementRecord,
                                              userAchievments:
