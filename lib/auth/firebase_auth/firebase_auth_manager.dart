  ...
  Future<BaseAuthUser?> _signInOrCreateAccount(
    ...
    try {
      ...
      return userCredential == null
          ? null
          : AirsoftArenaFirebaseUser.fromUserCredential(userCredential);
    } on FirebaseAuthException catch (e) {
        final errorMsg = switch (e.code) {
          'email-already-in-use' => null, // Не показываем - это нормально в нашей логике
          'INVALID_LOGIN_CREDENTIALS' => null, // Не показываем - попробуем создать аккаунт
          'user-not-found' => null, // Не показываем - попробуем создать аккаунт
