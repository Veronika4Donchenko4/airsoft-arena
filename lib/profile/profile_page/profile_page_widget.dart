...
class _ProfilePageWidgetState extends State<ProfilePageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.versionOutput = await actions.getAppVersion();
      _model.version = _model.versionOutput!;
      safeSetState(() {});
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                            ...
                            AuthUserStreamWidget(
                              builder: (context) => Column(
                                ...
                                children: [
                                  ...
                                  if (currentUserDocument?.subscription != null)
                                    StreamBuilder<SubscriptionRecord>(
                                                            ...
                                                            builder: (context) {
                                                              ...
                                                              return Column(
                                                                ...
                                                                children: List.generate(
                                                                    subOptionalList
                                                                        .length,
                                                                    (subOptionalListIndex) {
                                                                  final subOptionalListItem =
                                                                      subOptionalList[
                                                                          subOptionalListIndex];
                                                                  return Row(
                                                                    mainAxisSize:
                                                ...
                                                Padding(
                                                  padding: EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          4.0, 0.0, 0.0, 0.0),
                                                  child: Text(
                                                    'Раскройте потенциал своего клуба',
                                                ...
                                                Padding(
                                                  padding: EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          0.0, 2.0, 0.0, 0.0),
                                                  child: Text(
                                                    'Расширенные функции для управления играми и командами доступны после подписки',
                                                    textAlign: TextAlign.center,
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                          ...
                          InkWell(
                            ...
                            highlightColor: Colors.transparent,
                            onTap: () async {
                              context.pushNamed(ClansPageWidget.routeName);
                            },
                            child: Container(
                              width: double.infinity,
                              decoration: BoxDecoration(),
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              'Версия приложения: ${_model.version}',
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    font: GoogleFonts.inter(
